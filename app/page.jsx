  ...
  return (
    <div ref={containerRef} className="absolute inset-0 z-10">
      <Card
        ...
        src="https://images.unsplash.com/photo-1635373670332-43ea883bb081?q=80&w=1962&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        alt="example image"
        rotate="6deg"
        top="20%"
        left="25%"
...
const Card = ({ containerRef, src, alt, top, left, rotate, className }) => {
  ...
  return (
    <motion.img
      ...
      // dragMomentum={false}
      className={twMerge(
        "drag-elements absolute w-48 bg-neutral-200 p-1 pb-2",
        className
      )}
    ></motion.img>
  );
